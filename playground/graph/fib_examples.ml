...
print_endline
  (string_of_float
     (Fib.FibonacciPerformanceAnalysis.par_fib_calculation_time
        ~num_domains:current_num_domains
        ~sequential_threshold:sequential_threshold_upper current_fib_number));
...
Fib.FibonacciPerformanceAnalysis.par_calculation_time_num_domains_to_csv
  ~max_domains:max_num_domains ~sequential_threshold:sequential_threshold_upper
  current_fib_number;
...
Fib.FibonacciPerformanceAnalysis.par_calculation_time_fib_number_to_csv
  ~num_domains:current_num_domains ~sequential_threshold_lower
  ~sequential_threshold_upper ~min_n:min_fib_number ~max_n:max_fib_number
