...
\abstract{
This thesis addresses the parallelisation of graph algorithms in functional programming languages, with a focus on OCaml and the use of the Domainslib library.
...
\slovar{
  \geslo{paralelizacija}{parallelisation}
