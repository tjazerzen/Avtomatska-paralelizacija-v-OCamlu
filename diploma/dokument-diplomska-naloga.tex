...
Paralelna in sekvenčna verzija algoritma sta si zelo podobni. Glavna razlika je v tem, da paralelna verzija uporablja
paralelno verzijo funkcije \textit{map} za pridobivanje sosednjih vozlišč. Paralelno verzijo funkcije \textit{map}
sem implementiral tako, da sem seznam najprej pretvoril v \texttt{Array.t}, nato pa sem uporabil funkcijo Domainsliba
\texttt{Domainslib.Task.parallel\_for} za vzporedno izvajanje funkcije \textit{f} na vsakem elementu seznama, nato
pa sem rezultate pretvoril nazaj v OCamlov seznam. S tem povečamo hitrost iskanja naslednjega nivoja vozlišč.
