...
vozlišča razvršča v vrsto, nato pa iz vrste izbira vozlišča, ki jih bo raziskal. Tako lahko vozlišča obiskujemo
po nivojih, kjer nivo $0$ predstavlja zgolj množico vozlišča $s$, nivo $1$ predstavlja vozlišča, ki 
so od $s$ oddaljena za $1$ povezavo, in tako naprej.
