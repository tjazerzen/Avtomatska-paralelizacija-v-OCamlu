...
Definirali smo modul PQ, kjer vsak element v kopici predstavlja vozlišče s prednostno vrednostjo ter levim in desnim poddrevesom
...
primerjamo prednostno vrednost trenutnega korena z vrednostjo, ki jo vstavljamo ali izločamo. V odvisnosti od primerjave trenutne
prednostne vrednosti z vrednostjo, ki jo vstavljamo ali izločamo, se izvede ustrezna operacija. Za preprečevanje izrojenih dreves
...
vstavili element z največjo prednostno vrednostjo ter ga nam bo uspelo vstaviti pod list z največjo globino v drevesu (tedaj
...
Da bi rešili problem tveganega stanja v paralelni implementaciji Dijkstrovega algoritma, smo se odločili za uporabo mehanizmov medsebojnega izključevanja.
